...
import com.zexceed.aniflix.databinding.ItemMainOngoingBinding
...
class OngoingAdapter: ListAdapter<OnGoing, OngoingAdapter.ViewHolder>(DIFF_CALLBACK) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemMainOngoingBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ViewHolder(private val binding: ItemMainOngoingBinding) : RecyclerView.ViewHolder(binding.root) {
